                ...
                <div class="col-12">
                    <table id="example" class="table table-striped" style="width:100%">
                        ...
                        <tr>
                            ...
                            <td>Nguyễn Minh</td>
                            <td>Nữ</td>
                            <td>nguyenminh@gmail.com</td>
                            <td>0325836266</td>

                            <td class="project-actions text-right">
                                <a href="customer-detail.php" class="btn btn-info btn-sm"><i class="fas fa-eye"></i>

                                </a>

                                <button id="btn1" class="btn btn-danger" onclick="showModal()"> <i class="fas fa-trash"> </i>
